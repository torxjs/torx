...
let failed = 0;
const tests = [
   compare("Implicit only", "Johnny Appleseed", "@name", {
      name: "Johnny Appleseed",
   }),

   compare("Explicit only", "Johnny Appleseed", "@(name)", {
      name: "Johnny Appleseed",
   }),

   compare("Implicit with context", "<span>Johnny Appleseed</span>", "<span>@name</span>", {
      name: "Johnny Appleseed",
   }),
   ...
   compare(
      "Explicit inside parentheses",
      '<span style="background: url(images/photo.png)"></span>',
      '<span style="background: url(@(image))"></span>',
      { image: "images/photo.png" }
   ),

   compare("Explicit with context", "<span>Johnny Appleseed</span>", "<span>@(name)</span>", {
      name: "Johnny Appleseed",
   }),

   compare("Empty function", "<span>Johnny Appleseed</span>", "<span>@getName()</span>", {
      getName: function () {
         return "Johnny Appleseed";
      },
   }),

   compare("Function", "<span>JOHNNY APPLESEED</span>", '<span>@upperCase("Johnny Appleseed")</span>', {
      upperCase: function (string) {
         return string.toUpperCase();
      },
   }),

   compare("Function with quotes", "<span>JOHNNY (APPLESEED)</span>", '<span>@upperCase("Johnny (Appleseed)")</span>', {
      upperCase: function (string) {
         return string.toUpperCase();
      },
   }),
   ...
   compare(
      "Function with unmatched parentheses",
   ...
   compare(
      "Function with unmatched quotes",
   ...
   compare("Array", "<span>J</span>", "<span>@name[0]</span>", {
      name: "Johnny Appleseed",
   }),

   compare("Double array", "<span>J</span>", "<span>@names[0][0]</span>", {
      names: ["Johnny Appleseed"],
   }),

   compare("Double function", "<span>John</span>", '<span>@getShortName("Johnny Appleseed")(4)</span>', {
   ...
   compare("Sub variables", "<span>Johnny</span>", "<span>@fullName.firstName</span>", {
      fullName: {
         firstName: "Johnny",
         lastName: "Appleseed",
      },
